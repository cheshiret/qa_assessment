...
class DvdsControllerTest < ActionController::TestCase
  ...
  test "should create dvd" do
    assert_difference('Dvd.count') do
      post :create, dvd: { dvdid: @dvd.dvdid, dvdname: @dvd.dvdname, dvdtype: @dvd.dvdtype, price: @dvd.price, status: @dvd.status }
    end
  ...
  test "should update dvd" do
    patch :update, id: @dvd, dvd: { dvdid: @dvd.dvdid, dvdname: @dvd.dvdname, dvdtype: @dvd.dvdtype, price: @dvd.price, status: @dvd.status }
    assert_redirected_to dvd_path(assigns(:dvd))
  end
